...
export const DISTRICTS = {
  ...
  'Arunachal Pradesh': [
    ...
    'Shi Yomi', 'West Siang', 'East Siang', 'Upper Siang',
    'Lower Siang', 'Leparada', 'Siang', 'Dibang Valley',
    'Lower Dibang Valley', 'Lohit', 'Anjaw', 'Changlang',
    'Tirap', 'Longding'
  ],
  'Assam': [
    ...
    'Nagaon', 'Nalbari', 'Dima Hasao (North Cachar Hills)',
  ...
  'Chhattisgarh': [
    ...
    'Bijapur', 'Bilaspur', 'Dantewada (South Bastar)',
    'Dhamtari', 'Durg', 'Gariaband', 'Gaurella-Pendra-Marwahi',
    'Janjgir-Champa', 'Jashpur', 'Kabirdham (Kawardha)',
    'Kanker (North Bastar)', 'Kondagaon', 'Korba',
  ...
  'Odisha': [
    ...
    'Rayagada', 'Sambalpur', 'Subarnapur (Sonepur)',
    'Sundargarh'
  ],
  'Punjab': [
  ...
  'Sikkim': [
    'Gangtok', 'Namchi', 'Mangan', 'Gyalshing', 'Soreng', 'Pakyong'
  ],
  'Tamil Nadu': [
    ...
    'Theni', 'Thoothukudi (Tuticorin)', 'Tiruchirappalli',
  ...
  'Telangana': [
    ...
    'Komaram Bheem Asifabad', 'Mahabubabad', 'Mahabubnagar',
  ...
  'Delhi': [
    ...
    'North East Delhi', 'Shahdara', 'South West Delhi',
